...
def test_linear_solution():
    """
    Test problem where u = c*t + I is the exact solution, to be reproduced (to machine precision)
    by any relevant method.
    """
    ...
    u, t = leapfrogSolver(I=I, a=a1, b=b1, T=N*dt, dt=dt, N=N)
...
def test_case():
    ...
    u, t = leapfrogSolver(I=I, a=a, b=b, T=N*dt, dt=dt, N=N)
    u_e = exact_solution(t)
